...
public class FormattedTimeTest extends TestCase {
	...
	public void testToJson() throws UtilsException {
		...
		Assert.assertEquals("{\"time\":\"2016-01-23 14:23:00.000\"}",
				toJson(new FormattedTime("2016-01-23 14:23:00.000")));
	}
	...
	public void testFromJson() throws UtilsException {
		...
		Assert.assertEquals(new FormattedTime("2016-01-23 14:23").toString(),
				fromJson("{\"time\":\"2016-01-23 14:23\"}").toString());
		Assert.assertEquals(new FormattedTime("2016-01-23 14:23:00").toString(),
				fromJson("{\"time\":\"2016-01-23 14:23:00\"}").toString());
		Assert.assertEquals(new FormattedTime("2016-01-23 14:23:00.000").toString(),
				fromJson("{\"time\":\"2016-01-23 14:23:00.000\"}").toString());
